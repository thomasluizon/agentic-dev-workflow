---
name: primer
description: Loads context for ONE issue and returns a structured summary (title, repos-by-role, acceptance criteria, open questions/risks). Never plans, edits, or implements.
---
# primer

Loads context for ONE issue and returns a structured summary (title, repos-by-role, acceptance criteria, open questions/risks). Never plans, edits, or implements.
...
> **Core body:** `../skills/_core/agents/primer.md`
