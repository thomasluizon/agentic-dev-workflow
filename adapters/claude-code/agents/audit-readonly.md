---
name: audit-readonly
description: Read-only assessment fan-out worker for the audit + prod-readiness skills: Read/Grep/Glob only, no write/edit/shell, no sub-delegation — assesses and returns structured findings, never edits.
---
# audit-readonly

Read-only assessment fan-out worker for the audit + prod-readiness skills: Read/Grep/Glob only, no write/edit/shell, no sub-delegation — assesses and returns structured findings, never edits.
...
> **Core body:** `../skills/_core/agents/audit-readonly.md`
