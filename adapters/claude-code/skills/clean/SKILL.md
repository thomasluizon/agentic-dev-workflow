---
name: clean
description: Clean up git worktrees and local branches except protected and current ones.
---
# clean

Clean up git worktrees and local branches except protected and current ones.
...
> **Core body:** `../_core/pipeline/clean.md`
