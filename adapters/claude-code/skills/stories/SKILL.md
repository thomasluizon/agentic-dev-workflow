---
name: stories
description: Break a PRD or plan into independently grabbable issues using tracer-bullet vertical slices.
argument-hint: [source]
---
# stories

Break a PRD or plan into independently grabbable issues using tracer-bullet vertical slices.
...
> **Core body:** `../_core/intake/stories.md`
