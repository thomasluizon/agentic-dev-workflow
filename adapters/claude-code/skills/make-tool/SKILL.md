---
name: make-tool
description: Promote a repeated shell incantation into a reusable, agent-callable script under the project's tools dir — after you have run the same command twice.
argument-hint: [what it does]
---
# make-tool

Promote a repeated shell incantation into a reusable, agent-callable script under the project's tools dir — after you have run the same command twice.
...
> **Core body:** `../_core/meta/make-tool.md`
