---
name: commit-sweep
description: Report-only cross-commit, cross-repo regression sweep over a window of recent base-branch commits — the backstop for gotchas per-diff review misses.
argument-hint: [--since <when> | last N]
---
# commit-sweep

Report-only cross-commit, cross-repo regression sweep over a window of recent base-branch commits — the backstop for gotchas per-diff review misses.
...
> **Core body:** `../_core/review/commit-sweep.md`
