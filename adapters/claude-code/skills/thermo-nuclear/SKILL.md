---
name: thermo-nuclear
description: Maximum-rigor, behavior-preserving code-quality review with an adversarial verification harness.
argument-hint: [scope]
---
# thermo-nuclear

Maximum-rigor, behavior-preserving code-quality review with an adversarial verification harness.
...
> **Core body:** `../_core/review/thermo-nuclear.md`
