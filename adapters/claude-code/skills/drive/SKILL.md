---
name: drive
description: Resumable, spec-driven conductor for an epic or several issues across multiple sessions; a living spec survives a context reset.
argument-hint: [issue-number ...] | status <#...> | stop <#>
---
# drive

Resumable, spec-driven conductor for an epic or several issues across multiple sessions; a living spec survives a context reset.
...
> **Core body:** `../_core/pipeline/drive.md`
