---
name: prd
description: Generate a Product Requirements Document, warm from context or --cold via interview.
argument-hint: [output-filename] [--cold]
---
# prd

Generate a Product Requirements Document, warm from context or --cold via interview.
