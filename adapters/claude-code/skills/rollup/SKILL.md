---
name: rollup
description: Thin cross-repo CI-health roll-up: reads the latest base-branch run of each tracked gate and prints ONE GREEN/RED verdict. Reads conclusions only — runs nothing.
---
# rollup

Thin cross-repo CI-health roll-up: reads the latest base-branch run of each tracked gate and prints ONE GREEN/RED verdict. Reads conclusions only — runs nothing.
