---
name: audit-security
description: Repo-wide security audit: authz, injection, secrets, CORS, rate limits, error leakage.
argument-hint: [scope]
---
# audit-security

Repo-wide security audit: authz, injection, secrets, CORS, rate limits, error leakage.
...
> **Core body:** `../_core/review/audit-security.md`
