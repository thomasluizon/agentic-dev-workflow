---
name: implement
description: Execute a plan across the configured repos with validation loops.
argument-hint: [plan-path | issue-number ...]
---
# implement

Execute a plan across the configured repos with validation loops.
...
> **Core body:** `../_core/pipeline/implement.md`
