---
description: Web-research fan-out worker for deep-research: searches and fetches primary sources, verifies load-bearing facts against live pages, returns cited findings for one narrow slice. A leaf — cannot sub-delegate.
mode: subagent
---
# web-researcher

Web-research fan-out worker for deep-research: searches and fetches primary sources, verifies load-bearing facts against live pages, returns cited findings for one narrow slice. A leaf — cannot sub-delegate.
...
> **Core body:** `../skills/_core/agents/web-researcher.md`
