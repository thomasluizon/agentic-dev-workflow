---
description: Run lint, type-check, build, and tests across the configured repos (auto-detects which).
---
# validate

Run lint, type-check, build, and tests across the configured repos (auto-detects which).
...
> **Core body:** `../_core/pipeline/validate.md`
