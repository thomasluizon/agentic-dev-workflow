---
description: Gated conductor: issue -> prime -> grill -> plan -> implement, with a hard gate at every stage.
---
# execute

Gated conductor: issue -> prime -> grill -> plan -> implement, with a hard gate at every stage.
...
> **Core body:** `../_core/pipeline/execute.md`
