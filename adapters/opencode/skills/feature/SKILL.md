---
description: Idea -> PRD -> stories, gated: chains prd and stories with a hard confirmation gate before each.
---
# feature

Idea -> PRD -> stories, gated: chains prd and stories with a hard confirmation gate before each.
...
> **Core body:** `../_core/intake/feature.md`
