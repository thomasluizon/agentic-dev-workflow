---
description: Commit, push, and open a PR to the base branch; branches first if on a protected branch.
---
# ship

Commit, push, and open a PR to the base branch; branches first if on a protected branch.
...
> **Core body:** `../_core/pipeline/ship.md`
